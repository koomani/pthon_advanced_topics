...
print(float(1))                 # 1.0
# If you pass an object (obj) to the float(obj), it’ll delegate to the obj.__float__().
...
from math import isclose                        # SEE decimal module
...
print(floor(12.5))                 #12
print(floor(12.7))                 #12
# negaitvie flooring                        #SEE Python-float-to-int-floor-vs-trunc.png
print(floor(-12.7))                #-13
print(trunc(-12.7))                #-12
print(int(-12.7))                  #-12
...
from math import copysign       # math.copysign(x, y) x is the absolute value and y is the sign
def round_up(x):
